...
public class ShellDockableFrameFactory {
	...
	// clear the project view frame phase to close the opened project.
	...
	public static DockableFrame createProjectViewFrame() {
		projectFrame = new DockableFrame("Project",
				ShellIconsFactory.getImageIcon(ShellIconsFactory.Standard.SOLUTION));
	...
	public static DockableFrame createInspectionFrame() {
		DockableFrame frame = new DockableFrame("Inspection",
				ShellIconsFactory.getImageIcon(ShellIconsFactory.Standard.SERVER));
	...
	public static DockableFrame createOutputFrame(JTextArea textArea) {
		DockableFrame frame = new DockableFrame("Output",
	...
	public static DockableFrame createFindResultFrame() {
		DockableFrame frame = new DockableFrame("Find Results",
				ShellIconsFactory.getImageIcon(ShellIconsFactory.Standard.FINDRESULT));
		frame.getContext().setInitMode(DockContext.STATE_AUTOHIDE);
		frame.getContext().setInitSide(DockContext.DOCK_SIDE_SOUTH);
		frame.getContext().setInitIndex(0);
